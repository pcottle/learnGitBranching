exports.dialog = {
  ...
  'te_IN': [{
    ...
    options: {
      markdowns: [
        '## స్థాయి నిర్మాణ సాధనానికి స్వాగతం!',
        '',
        'ప్రధాన దశలు ఇవి:',
        '',
        '  * Git కమాండ్లతో ప్రారంభ వాతావరణాన్ని సిద్ధం చేయండి',
        '  * ```define start``` తో ప్రారంభ ట్రీని నిర్వచించండి',
        '  * (సరైన) పరిష్కారాన్ని ఏర్పరిచే Git కమాండ్ల వరుసను ఇవ్వండి',
        '  * ```define goal``` తో లక్ష్య ట్రీని నిర్వచించండి. లక్ష్యాన్ని నిర్వచిస్తే పరిష్కారం కూడా నిర్వచించినట్టే',
        '  * కావాలంటే ```define hint``` తో సూచనను నిర్వచించండి',
        '  * ```define name``` తో పేరును మార్చండి',
        '  * కావాలంటే ```edit dialog``` తో ఒక చక్కటి ప్రారంభ సందేశాన్ని నిర్వచించండి',
        '  * మీ స్థాయి JSON రూపంలో పొందడానికి ```finish``` కమాండ్ ఇవ్వండి!'
      ]
    }
  }],
  'de_DE': [{
  ...
  'bg': [{
    ...
    options: {
      markdowns: [
        '## Добре дошъл в създаването на нива!',
        '',
        'Ето основните стъпки:',
        '',
        '  * Настрой началната среда с git команди',
        '  * Дефинирай началното дърво с ```define start```',
        '  * Въведи серията от git команди, които съставят (оптималното) решение',
        '  * Дефинирай целевото дърво с ```define goal```. Дефинирането на целта също така дефинира и решението',
        '  * По желание дефинирай подсказка с ```define hint```',
        '  * Редактирай името с ```define name```',
        '  * По желание дефинирай хубав начален диалог с ```edit dialog```',
        '  * Въведи командата ```finish```, за да генерираш JSON на нивото си!'
      ]
    }
  }],
  'ru_RU': [{
