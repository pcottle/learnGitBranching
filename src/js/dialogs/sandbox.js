...
exports.dialog = {
  ...
  'bg': [{
    ...
    options: {
      markdowns: [
        '## Добре дошли в Learn Git Branching',
        '',
        'Искаш да научиш Git? Е, дошъл си на правилното място! ',
        '"Learn Git Branching" е най-визуалният и интерактивен начин да научиш Git ',
        'в уеб; ще бъдеш предизвикан с вълнуващи нива, ще получиш поетапни ',
        'демонстрации на мощни функции и може би дори ще се позабавляваш междувременно.',
        '',
        'След този диалог ще видиш разнообразието от нива, които предлагаме. Ако си ',
        'начинаещ, просто започни с първото. Ако вече знаеш някои основи на Git, ',
        'опитай някои от по-късните, по-предизвикателни нива.',
        '',
        'Можеш да видиш всички налични команди с `show commands` в терминала.',
        '',
        'PS: Искаш да отидеш директно в пясъчника (sandbox) следващия път?',
        'Пробвай ',
        '[този специален линк](https://pcottle.github.io/learnGitBranching/?NODEMO)',
        '',
        'PPS: GitHub започна да именува основния клон `main` вместо `master`, ',
        'за да се отдалечи от терминология с предразсъдъци [(повече детайли тук)](https://github.com/github/renaming). ',
        'В съответствие с това движение в цялата индустрия, ние също актуализирахме "Learn Git Branching", за да ',
        'използва `main` вместо `master` в нашите уроци. Това преименуване би трябвало да е доста последователно ',
        'към момента, но ако забележиш грешки, чувствай се свободен да изпратиш PR (или да отвориш issue).'
      ]
    }
  }],
  'ru_RU': [{
  ...
  'te_IN': [{
    ...
    options: {
      markdowns: [
        '## Learn Git Branching కి స్వాగతం',
        '',
        'Git నేర్చుకోవాలనుకుంటున్నారా? అయితే మీరు సరైన చోటుకు వచ్చారు! ',
        '"Learn Git Branching" అనేది వెబ్‌లో Git నేర్చుకోవడానికి ఉన్న అత్యంత ',
        'చక్కటి దృశ్యమాధ్యమ పద్ధతి; ఉత్తేజపూరితమైన స్థాయిలతో మిమ్మల్ని సవాలు చేస్తుంది, ',
        'శక్తివంతమైన ఫీచర్ల గురించి అడుగులుగా నేర్పిస్తుంది, దారిలో కొంచెం వినోదం కూడా ఇస్తుంది.',
        '',
        'ఈ సందేశం తర్వాత మేము అందించే వివిధ స్థాయిలు మీకు కనిపిస్తాయి. మీరు కొత్తవారైతే, ',
        'మొదటి స్థాయితోనే ప్రారంభించండి. Git ప్రాథమికాలు ఇప్పటికే తెలిసి ఉంటే, ',
        'చివర్లో ఉన్న కష్టమైన స్థాయిలను ప్రయత్నించండి.',
        '',
        'అందుబాటులో ఉన్న అన్ని కమాండ్లను చూడాలంటే టెర్మినల్‌లో `show commands` టైప్ చేయండి.',
        '',
        'గమనిక: తర్వాతిసారి నేరుగా sandbox లోకి వెళ్ళాలనుకుంటున్నారా? ',
        '[ఈ ప్రత్యేక లింక్](https://pcottle.github.io/learnGitBranching/?locale=te_IN&NODEMO) ప్రయత్నించండి.'
      ]
    }
  }],
  'ta_IN': [{
