exports.strings = {
  ...
  'git-error-origin-fetch-no-ff': {
    ...
    'ko': '당신의 오리진 브랜치가 원격 브랜치와 동기화되지 않아서 패치를 실행할 수 없습니다.',
  ...
  'git-error-origin-push-no-ff': {
    ...
    'ko': '원격 레포지토리가 당신의 로컬 레포지토리에서 분기하므로, 변경 사항을 업데이트 하려면 간단한 fast forward로는 아닙니다(따라서 push는 거절될 것입니다.). 원격 레포지토리에서의 변경 사항을 내려 받아 이 브랜치에 합치고, 이를 반복하세요. 당신은 git pull 또는 git pull --rebase를 사용해 이를 수행할 수 있습니다.',
  ...
  'git-error-options': {
    ...
    'ko': '당신이 지정한 옵션들은 호환되지 않거나 올바르지 않습니다.',
  ...
  'branch-name-short': {
    ...
    'ko': '죄송하지만, 우리는 시각적으로 더 보기편하게 짧은 브랜치명이 필요합니다. 당신의 브랜치명은 9자리로 잘라 "{branch}"로 만들었습니다.',
  ...
  'mobile-alert': {
    ...
    'ko': 'LGB는 모바일에서 입력을 받을 수 없습니다. 데스크톱으로 접속하세요! 후회하지 앉을겁니다. :D',
  ...
  'share-tree': {
    ...
    'ko': '친구들과 이 트리를 공유하세요! 친구들도 "import tree"를 사용해 트리를 로드할 수 있습니다.',
  ...
  'solved-map-reset': {
    ...
    'ko': '이미 해결된 지도가 초기화 되었습니다. 당신은 초기 상태에서 시작합니다.',
  ...
  'define-start-warning': {
    ...
    'ko': '시작 지점을 정의하세요... 만약 그것이 정의된다면 해답과 목표가 덮어씌워질 것입니다.',
  ...
  'help-vague-level': {
    ...
    'ko': '당신이 레벨에 들어가 있을때, 여러가지 도움을 빌릴 수 있습니다. 레슨에 대해 더 알고싶을 땐 "help level", LearnGitBranching을 사용하고 싶을 땐 "help general", 또는 레벨을 어떻게 해결해야할지 알고싶을 땐 "objective"를 선택하세요.',
  ...
  'help-vague-builder': {
    ...
    'ko': '당신은 한 레벨 생성기에 들어가 있고, 여러가지 도움을 빌릴수 있습니다. "help general" 또는 "help builder"를 선택해주세요.',
