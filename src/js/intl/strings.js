exports.strings = {
  ...
  "finish-dialog-win": {
    ...
    pt_BR:
      "Maravilha! Você fez uma solução tão boa quanto ou melhor que a nossa.",
  ...
  "finish-dialog-lose": {
    __desc__:
      "When the user entered more commands than our best, encourage them to do better",
  ...
  "hg-prune-tree": {
    ...
    en_US:
      "Warning! Mercurial does aggressive garbage collection and thus needs to prune your tree",
    zh_CN: "注意！ Mercurial 会进行主动垃圾回收，需要将你的提交树縮小。",
    zh_TW:
      "注意！ Mercurial 會積極地做垃圾收集，而且會因此把你的 tree 給縮小。",
    es_AR:
      "¡Cuidado! Mercurial hace garbage collection agresivamente y necesita eliminar tu árbol",
    es_MX:
      "¡Cuidado! Mercurial hace garbage collection agresivamente y necesita eliminar tu árbol",
    es_ES:
      "¡Cuidado! Mercurial hace la recolección de basura agresivamente (para administrar memoria) y necesita podar tu árbol.",
    pt_BR:
      "Cuidado! O Mercurial faz coleção de lixo agressiva e precisa prunar sua árvore",
    gl:
      "¡Coidado! Mercurial fai que recolección de lixo agresivamente (para limpar memoria) e precisa podar a túa árbore.",
    fr_FR:
      "Attention, Mercurial supprime de façon agressive et nécessite un prune du repository",
    de_DE:
      "Achtung! Mercurial macht aggressive Garbage Collection und muss daher deinen Baum reduzieren",
    ru_RU:
      "Внимание! Mercurial использует агрессивный сборщик мусора и обрезает ваше дерево",
    uk: "Увага! Mercurial агресивно збирає сміття й може обрізати твоє дерево ",
    ko:
      "주의! Mercurial은 공격적으로 가비지 컬렉션을 수행하므로 트리를 정리할 필요가 있습니다.",
    vi:
      "Cảnh báo! Mercurial cần thực hiện thu gom rác và thu nhỏ cây lịch sử của bạn.",
    sl_SI:
      "Opozorilo! Mercurial ima agresivno politiko garbage collectiona in bo obrezal vaše drevo",
    pl:
      "Ostrzeżenie! Mercurial prowadzi agresywną kolekcję śmieci i dlatego musi przycinać Twoje drzewo",
    ta_IN:
      "எச்சரிக்கை! மெர்குரியல் வலிய களிவு சேகரிப்பு செய்கிறது, இதனால் உங்கள் மரத்தை கத்தரிக்க வேண்டிவரும்",
    it_IT:
  ...
  "hg-a-option": {
    ...
    es_AR:
      "La opción -A no es necesaria para esta aplicación, simplemente hacé commit",
    es_MX:
      "La opción -A no es necesaria para ésta aplicación, simplemente se hace commit",
    es_ES:
      "La opción -A no se necesita para este aplicación, sólo hace un commit!",
    pt_BR:
      "A opção -A não é necessária para este aplicativo, simplesmente faça commit",
    gl: "A opción -A non se necesita para este aplicativo, ¡fai só un commit!",
    de_DE:
      "Die Option -A wird in dieser Anwendung nicht benötigt, committe einfach!",
    fr_FR:
      "L'option -A n'est pas nécessaire pour cette application, simplement commiter",
    ru_RU:
      "Опция -A не требуется для этого приложения, просто сделайте коммит.",
    uk: "Опція -A не потрібна для цього застосунку, можна просто комітити!",
    ko: "이 앱에선 -A 옵션은 필요 없습니다. 그냥 커밋하세요!",
    vi:
      "Không cần thiết phải dùng tùy chọn -A trên ứng dụng này, cứ commit là được!",
  ...
  "hg-error-no-status": {
    ...
    en_US:
      "There is no status command for this app, since there is no staging of files. Try hg summary instead",
    zh_CN:
      "本 App 没有 status 命令哦，因为根本没有 stage 缓存文件。可以用 hg summary 代替哦",
    zh_TW:
      "本 App 没有 status 命令哦，因为根本没有 stage 缓存文件。可以用 hg summary 代替哦",
    es_AR:
      "No hay un comando status para esta aplicación, dado que no hay archivos que indexar. Probá hg summary, en cambio",
    es_MX:
      "No hay un comando status para esta aplicación, dado que no hay archivos que indexar. Prueba `hg summary`, en cambio",
    es_ES:
      "No hay un comando status para esta aplicación, porque no hay archivos que indexar. Prueba el comando hg summary",
    pt_BR:
      "Não existe um comando status para este aplicativo, já que não há staging de arquivos. Tente hg summary",
    gl:
      "Non hai un comando status para esta aplicación, xa que non hai ficheiros que indexar. Proba hg summary",
    fr_FR:
      "Il n'y a pas de commande status pour cette application, car il n'y a pas de fichier stagé. Essayez hg summary à la place.",
    de_DE:
      "Es gibt keinen Befehl status in dieser Anwendung, da es kein Staging von Dateien gibt. Probier stattdessen hg summary",
    ru_RU:
      "Команда status не поддерживается в этом приложении, так как здесь нет файлов. Попробуйте выполнить hg summary",
    uk:
      "Команда status не підтримується в цьому застосунку, так як немає стейджингу(staging) файлів. Натомість спробуй hg summary ",
    ko:
      "이 앱을 위한 상태 명령어는 없습니다. 왜냐하면 파일들의 스테이징이 없기 때문입니다. 대신 hg summary를 시도해보세요.",
    vi:
      "Ứng dụng này không hỗ trợ lệnh `status` vì không có tệp nhớ đệm, thay vì đó hãy dùng lệnh `hg summary`",
    sl_SI:
      "Za to aplikacijo ni na voljo `status` ukaza, ker tu ni `stage-anja` datotek. Poizkusiš lahko `hg summary`",
    pl:
  ...
  "hg-error-log-no-follow": {
    ...
    es_ES:
      "Actualmente hg log sin -f no es compatible con esta aplicación. Usa -f.",
    ...
    ru_RU:
      "hg log без опции -f в настоящий момент не поддерживается, используйте -f",
    uk: "hg log без опції -f в данний момент не підтримується, використовуй -f",
    ko: "-f가 없는 hg log는 현재 지원되지 않습니다. -f를 사용하세요.",
    vi:
      "Hiện tại thì `hg log` mà không có tùy chọn -f chưa được hỗ trợ, hãy viết thêm -f.",
  ...
  "git-dummy-msg": {
    __desc__:
      "The dummy commit message for all commits. Feel free to put in a " +
  ...
  "git-error-origin-fetch-no-ff": {
    __desc__: "One of the error messages for git",
    en_US:
      "Your origin branch is out of sync with the remote branch and fetch cannot be performed",
    zh_CN: "你的 origin 仓库中的分支与远程分支的不同步了，无法执行 fetch 命令",
    zh_TW:
      "你的 origin 分支已經失去了與 remote 遠端分支的同步，所以無法執行 fetch 命令",
    de_DE:
      "Dein origin Branch ist nicht auf dem Stand des Remote Branches und fetch kann nicht ausgeführt werden",
    es_AR:
      "Tu rama origin está desincronizada con la rama remota, por lo que no se puede hacer el fetch",
    es_MX:
      "Tu rama origin está desincronizada con la rama remota, por lo que no se puede hacer el fetch",
    es_ES:
      "Tu rama origin no está sicronizada con la rama remota, así que el fetch no se puede realizar.",
    pt_BR:
      "O fetch não pode ser realizado pois o ramo de origem está fora de sincronia com o ramo remoto",
    gl:
      "O fetch non pode ser realizado xa que a rama de orixe non está sincronizada  ca rama remota",
    fr_FR:
      "Votre branche origin n'est plus synchronisée avec la branche distante et fetch ne peut pas être appliqué. Essayez avec l'option --force",
    ru_RU:
      "Ваша origin ветка не синхронизирована с удаленной веткой, невозможно выполнить fetch",
    uk:
      "Твоя гілка origin не синхронізована з віддаленою гілкою, неможливо виконати fetch",
    ko:
      "당신의 오리진 브랜치가 원격 브랜치와 동기화되지 않았고, 패치를 실행할 수 없습니다.",
    vi:
      "Nhánh của bạn không đồng bộ với nhánh remote nên lệnh fetch không thực thi được.",
    sl_SI:
      "Tvoj origin branch ni sinhroniziran z oddaljenim branchem, zato se fetch se ne more izvesti",
    pl:
  ...
  "git-error-origin-push-no-ff": {
    __desc__: "One of the error messages for git",
    en_US:
      "The remote repository has diverged from your local repository, so uploading your changes is not a simple fast forward (and thus your push was rejected). Please pull down the new changes in the remote repository, incorporate them into this branch, and try again. You can do so with git pull or git pull --rebase",
    zh_CN:
      "远程仓库与你的本地仓库产生了分歧，故此上传操作无法通过 Fast-forward 实现（因此你的 push 被拒绝了）。请 pull 下来远程仓库里最新的更改，与这个分支合并之后再试一次。你可以通过 git pull 或 git pull --rebase 实现。",
    zh_TW:
      "遠端倉庫與你的本地倉庫產生了分歧，故此上傳操作無法通過簡單地快進實現（因此你的 push 被拒絕了）。請 pull 下來遠端裡最新的更改，與本地合併之後再試一次。你可以通過 git pull 或 git pull --rebase 實現。",
    de_DE:
      "Das entfernte Repository weicht von deinem lokalen Repository ab, daher können deine Änderungen nicht mit einem einfachen fast forward hochgeladen werden (und daher ist dein push abgelehnt worden). Bitte pull erst die neuen Änderungen in das lokale Repository, integriere sie in den Branch und versuch es nochmal. Das kannst du mit git pull oder git pull --rebase machen",
    es_AR:
      "El repositorio remoto divergió de tu repositorio local, por lo que subir tus cambios no es un simple fast forward (y por eso se rechazó tu push). Por favor, hacé pull de los nuevos cambios en el repositorio remoto, incorporalos a esta rama y probá de nuevo. Podés hacerlo con git pull o git pull --rebase",
    es_MX:
      "El repositorio remoto divergió de tu repositorio local, por lo que subir tus cambios no es un simple fast forward (y por eso se rechazó tu push). Por favor, hacé pull de los nuevos cambios en el repositorio remoto, incorporalos a esta rama y prueba de nuevo. Puedes hacerlo con `git pull` o `git pull --rebase`",
    es_ES:
      'El repositorio remoto se ha desviado del repositorio local. Subir cambios no es un avance en cámara rápida (por eso fue rechazado tu push). Por favor haz pull para descargar los cambios en el repositorio remoto para que los incorpores en la rama actual. Los cambios se pueden hacer pull con el comando "git pull" o "git pull --rebase"',
    pt_BR:
      "O repositório remoto divergiu do repositório local, então enviar suas mudanças não é um simples fast forward (e por isso seu push foi rejeitado). Por favor, faça pull das novas mudanças do repositório remoto, incorpore-os a este ramo, e tente novamente. Você pode fazê-lo com git pull ou git pull --rebase",
    gl:
      'O repositorio remoto diverxe do teu repositorio local. Subir os cambios non é un fast-forward (avance rápido) e por iso foi rechazado o teu push. Por favor, fai un pull dos novos cambios do repositorio remoto e inclúeos na túa rama actual. Os cambios pódense facer co comando "git pull" ou "git pull --rebase"',
    fr_FR:
      "Le dépôt distant a divergé de votre référentiel local, donc l'envoi de vos modifications n'est pas en simple avance rapide (et donc votre envoi a été rejeté). Veuillez récupérer les nouveaux changements depuis le dépôt distant, les intégrer dans cette branche, et essayez à nouveau. Vous pouvez le faire avec git pull ou git pull --rebase",
    ru_RU:
    ...
    uk:
      "Віддалений репозиторій розбігся з твоїм локальним репозиторієм, тому відвантаження твоїх змін не є простим fast forward (і тому твій push був відхилений). Будь-ласка, витягни зміни з віддаленого репозиторію, включи їх в цю гілку, й спробуй ще. Ти можеш зробити це за допомогою git pull чи git pull --rebase",
    ko:
      "원격 레포지토리가 당신의 로컬 레포지토리에서 분기하므로, 변경 사항을 업데이트 하는것은 간단한 fast forward가 아닙니다(따라서 push가 거절될 것입니다.). 원격 레포지토리에서의 변경 사항을 내려 받아 이 브랜치에 합치고, 이를 반복하세요. 당신은 git pull 또는 git pull --rebase를 사용해 이를 수행할 수 있습니다.",
    vi:
      "Kho chứa từ xa có sự khác biệt với kho chứa cục bộ của bạn, nên không thể tự động (fast forward) cập nhật thay đổi của bạn (và vì thế hoạt động push của bạn bị từ chối). Vui lòng kéo về thay đổi từ kho chứa từ xa, kết nạp vào nhánh hiện tại, và thử lại lần nữa. Bạn có thể dùng lệnh `git pull` hoặc `git pull --rebase`",
    sl_SI:
      "Oddaljen repozitorij se je ločil od tvojega lokalnega repozitorija, zato nalaganje sprememb ni možno z `fast forward` opcijo (zato je bil `push` zavrnjen). Prosim pull-aj dol nove spremembe iz oddaljenega repozitorija, jih vključi v svoj branch, nato pa poizkusi ponovno. To lahko narediš z `git pull` ali `git pull --rebase`",
    pl:
  ...
  "git-error-branch": {
    __desc__: "One of the error messages for git",
    en_US:
      "You can't delete the main branch, the branch you are on, or things that " +
      "aren't branches",
    de_DE:
      "Du kannst nicht den Branch main, den Branch auf dem du gerade arbeitest oder Refs, die keine Branches sind, löschen",
    zh_CN:
      "你不能删除主分支（main），或者你当前所在的分支，或者其它连分支也不是的东西。",
    zh_TW:
      "你不能刪除 main branch，或者你當前所在的 branch，或者其它連 branch 都不是的東西。",
    es_AR:
      "No podés borrar la rama main, la rama en la que estás, o cosas que no son ramas",
    es_MX:
      "No puedes borrar la rama main, la rama en la que estás, o cosas que no son ramas",
    es_ES:
      "No puedes eliminar la rama main, la rama en que estás, o cosas que no son ramas.",
    pt_BR:
      "Você não pode apagar o ramo main, nem o ramo em que você está, nem coisas que não sejam ramos",
    gl:
      "Non podes borrala rama main, nin a rama na que ti estás, nin cousas que non sexan ramas",
    fr_FR:
      "Vous ne pouvez supprimer la branche main, la branche sur laquelle vous êtes, ou ce qui n'est pas une branche",
    ru_RU:
      "Невозможно удалить ветку main, ветку на которой вы сейчас и то что не является веткой",
    uk:
      "Неможливо видалити гілку main, гілку на якій ти зараз знаходишся чи штуки які не є гілкою",
    ko:
      "당신은 메인 브랜치, 당신이 현재 사용중인 브랜치, 또는 브랜치가 아닌 것들을 삭제할 수 없습니다.",
    vi:
      "Bạn không thể xóa nhánh main, nhánh mà bạn đang tham chiếu tới, hoặc những gì không phải nhánh.",
    sl_SI:
      "Ne moreš izbrisati main brancha, brancha na katerem si trenutno ali stvari, ki niso branchi",
    pl:
  ...
  "git-error-rebase-none": {
    ...
    de_DE:
      "Keine Commits für Rebase gefunden! Alle Commits sind Merge Commits oder beinhalten nur schon vorhandene Änderungen",
    zh_CN: "没有可以 rebase 的提交记录！可能是合并提交，或者已经 rebase 过了。",
    zh_TW:
      "沒有需要 rebase 的 commit！每個都是一個 merge commit 或者修改已經被寫入了",
    es_AR:
      "¡No hay commits para rebasear! Son todos commits de merge o cambios ya aplicados",
    es_MX:
      "¡No hay commits para hacer rebase! Todo es un merge commit o cambios ya aplicados",
    es_ES:
      "¡No hay commits para hacer rebase! Todo es un merge commit o cambios ya hecho.",
    pt_BR:
      "Não há commits para o rebase! São todos commits de merge ou mudanças já aplicadas",
    gl:
      "¡Non hai commits para o rebase! Son todos commits de merge ou cambios xa aplicados",
    fr_FR:
      "Aucun commit à rebaser ! C'est soit un commit de merge, soit des modifications déjà appliquées",
    ru_RU:
      "Нет коммитов для rebase! Все в коммите слияния или изменения уже применены",
    uk:
      "Нема комітів для rebase! Все в коміті злиття (merge commit) чи зміни вже застосовані",
    ko:
      "rebase를 하기 위한 커밋이 없습니다! 모든 커밋과 변경 사항들의 병합은 이미 적용되었습니다.",
    vi:
      "Không có commit nào để rebase. Mọi thứ là merge commit hoặc thay đổi đã được áp dụng.",
    sl_SI:
      "Ni commitov za rebase! Vse je merge commit ali pa so spremembe že dodane",
    pl:
  ...
  "git-warning-detached": {
    ...
    ru_RU:
      "Внимание! Репозиторий в состоянии detached HEAD, то есть не находится ни на какой ветке!",
    uk:
      "Увага! Репозиторій в стані detached HEAD, тобто не знаходиться в жодній гілці!",
    ko: "주의! 분리된 HEAD 상태",
  ...
  "git-error-options": {
    ...
    fr_FR:
      "Les options que vous avez spécifiées sont incompatibles ou incorrectes",
  ...
  "git-error-already-exists": {
    ...
    fr_FR:
      "Le commit {commit} existe déjà dans votre ensemble de modifications, opération avortée !",
  ...
  "git-error-reset-detached": {
    ...
    de_DE:
      "Kann im Detached Head Zustand kein reset ausführen! Bitte checkout zum Bewegen benutzen",
    zh_CN: "不能在分离的 HEAD 里重置！用 checkout 吧",
    zh_TW: "不能在分離 HEAD 的狀態中重來！用 checkout 來移動吧",
    es_AR:
      "No podés hacer reset en el modo detached. Usá checkout si querés moverte",
    es_MX:
      "No puedes hacer reset en el modo separado. Usa checkout si quieres moverte",
    es_ES:
      "No puedes hacer reset en el modo separado. Usa checkout si quieres moverte.",
    pt_BR:
      "Não se pode fazer reset no modo detached. Use checkout se quiser se mover",
    gl:
      "Non se pode facer reset no modo detached. Use checkout se te queres mover",
    fr_FR:
      "On ne peut pas effectuer un reset quand HEAD est détaché. Utilisez checkout pour déplacer",
    ru_RU: "Это невозможно в режиме detached HEAD! Используйте checkout!",
    uk:
      "Неможливо зробити reset в стані detached head! Використовуй checkout якщо хочеш змінити розташування",
    ko:
      "분리된 HEAD에서 reset할 수 없습니다. 만약 이동시키기를 원한다면 checkout을 사용하세요.",
    vi:
      "Trong trạng thái tách rời `HEAD` thì không thể `reset`. Dùng `checkout` nếu bạn muốn di chuyển.",
  ...
  "git-warning-hard": {
    ...
    de_DE:
      "Das Standardverhalten in dieser Demo ist --hard, du kannst die Option auch weglassen!",
    zh_CN:
      "在本程序中默认的行为是 --hard 硬重置，可以尽情省略掉那个选项以避免麻烦！但是要记录 Git 中默认的是 --mixed。",
    zh_TW: "預設的行為是 --hard reset，儘量省略掉那個選項吧！",
    es_AR:
      "El comportamiento default es un --hard reset, sentite libre de omitir esa opción!",
    es_MX:
      "El comportamiento default es un --hard reset, siéntete libre de omitir esa opción!",
    es_ES:
      "El comportamiento default para reajustes es --hard, pero siéntete libre de omitir esa " +
      "opción si te cansas de escribirla en nuestras lecciones. Recuerda quepor defecto el comportamiento en GitHub es --mixed.",
    pt_BR:
      "O comportamento padrão é um reset --hard, fique livre para omitir essa opção!",
    gl:
      "O comportamente por defecto é un reset --hard, Lembra que por defecto en GitHub é --mixed.",
    fr_FR:
      "Le comportement par défaut est un --hard reset, soyez libre d'omettre cette option !",
    ru_RU:
      "По умолчанию будет выполнен --hard reset, эту опцию можно опускать!",
    uk:
      "На LearnGitBranching reset по замовчуванню використовує --hard, тому цю опцію " +
    ...
    vi:
      'Trạng thái mặc định cho lệnh `reset` của "Học nhánh Git" là `--hard`.' +
    ...
    sl_SI:
      "Privzeto delovanje za reset na LearnGitBranching je --hard, zato lahko to izpustiš. Na pravem gitu je --mixed.",
    pl:
      "Domyślnym zachowaniem dla polecenia `reset` w LearnGitBranching jest parametr --hard, więc możesz pominąć tę opcję, " +
  ...
  "git-error-staging": {
    __desc__: "One of the error messages for git",
    en_US:
      "There is no concept of adding / staging files, so that option or " +
      "command is invalid!",
    de_DE:
      "In dieser Demo gibt es kein Hinzufügen / Vormerken von Dateien, dieser Befehl ist daher ungültig!",
    zh_CN: "没有添加、缓存文件的必要，所以该选项或者命令是不合法的。",
    zh_TW:
      "沒有加入、或者暫存 (staging) 文件的必要，所以改選項或者命令是不合法的。",
    es_AR:
      "No existe el concepto de agregar/indexar cambios, así que esa opción o comando es inválido",
    es_MX:
      "No existe el concepto de agregar/indexar cambios, así que esa opción o comando es inválido",
    es_ES:
      "No existe el concepto de agregar/indexar cambios, así que esa opción o comando es inválido.",
    pt_BR:
      "Não existe o conceito de adicionar/indexar mudanças, de forma que essa opção ou comando é inválida",
    gl:
      "Non existe o concepto de agregar/indexar cambios, así que esa opción ou comando é inválido.",
    fr_FR:
      "Il n'y a pas le concept d'ajouter / mettre en staging, donc cette option ou commande est invalide",
    ru_RU: "Это демо не работает с файлами, так что git add не нужен!",
    uk:
      "В цьому демо немає можливості додати файл до робочої копії чи до стейджингу, тому ця опція чи команда некоректна чи не підтримується",
    ko:
      "여기엔 파일을 추가하거나 스테이징한다는 개념이 없습니다. 따라서 그 옵션 또는 명령어는 유효하지 않습니다.",
    vi:
      "Không có khái nệm thêm tập tin đệm(staging file), nên tùy chọn đó là bất hợp lệ.",
    sl_SI:
      "Tu ni možnosti addanja/stageanja datotek, zato je ta ukaz nepravilen",
    pl:
  ...
  "git-error-command-not-supported": {
    __desc__:
      "Message that appears in git console when command was not recognized.",
  ...
  "branch-name-short": {
    __desc__:
      "When branch names get too long, we need to truncate them. This is the warning for that",
    en_US:
      'Sorry, we need to keep branch names short for the visuals. Your branch name was truncated to 9 characters, resulting in "{branch}"',
    de_DE:
      'Tut mir leid, aber aus Gründen der Darstellung müssen wir die Branch-Namen kurz halten. Dein Branch-Name wurde auf 9 Zeichen gekürzt und heißt daher jetzt "{branch}"',
    zh_CN:
      '抱歉，为了显示的需要，我们需要一个短些的分支名称。您使用的名称将被截断到9个字符，即 "{branch}"',
    zh_TW:
      '抱歉，為了顯示的需要，我們需要一個短一點的 branch 名稱。您使用的將會被截斷到剩下9個字元，即"{branch}"',
    es_AR:
      'Perdón, necesitamos mantener los nombres de los branches cortos para visualizarlos. El nombre de tu rama se truncó a 9 caracteres, resultando en "{branch}"',
    es_MX:
      'Perdón, necesitamos mantener los nombres de las ramas cortos para visualizarlos. El nombre de tu rama se truncó a 9 caracteres, resultando en "{branch}"',
    es_ES:
      'Perdón, necesitamos mantener los nombres de las ramas cortos para visualizarlos. El nombre de tu rama se truncó a 9 caracteres, resultando en "{branch}"',
    pt_BR:
      'Desculpe, precisamos manter os nomes dos ramos curtos para visualizá-los. O nome do seu ramo foi truncado para 9 caracteres, resultando em "{branch}"',
    gl:
      'Desculpe, precisamos manter os nomes das ramas curtas para poder velas. O nome da súa rama foi truncada a 9 letras, resultado en "{branch}"',
    fr_FR:
      'Désolé, nous devons garder les noms de branches courts pour la visualisation. Votre nom de branche a été tronqué à 9 caractères, devenant "{branch}"',
    ru_RU:
      'Для наглядности нам нужно сохранять имена веток короткими. Твоё название сокращено до 9 символов и теперь это "{branch}"',
    uk:
      'Вибач, нам потрібно щоб ім’я гілок було як можна коротше для наглядності. Твоє ім’я гілки було скорочене до 9 літер й тепер це "{branch}"',
    ko:
      '미안하지만, 우리는 시각적으로 더 좋게 보기위해 짧은 브랜치명이 필요합니다. 당신의 브랜치명은 9자리로 잘라 "{branch}"로 만들었습니다.',
    vi:
      'Xin lỗi, chúng tôi cần giữ tên nhánh ngắn để tiện minh họa. Tên nhánh của bạn đã bị cắt xuống 9 ký tự là "{branch}".',
    sl_SI:
      'Oprosti, imena branchev moramo obdržati kratka zaradi vizualizacije. Tvoje ime brancha je bilo skrajšano na 9 črk, kar predstavlja "{branch}"',
    pl:
  ...
  "option-not-supported": {
    __desc__:
      "When the user specifies an option that is not supported by our demo",
  ...
  "git-supported-commands": {
    __desc__:
      "In the git help command, the header above the supported commands",
  ...
  "git-usage": {
    __desc__:
      "In the dummy git output, the header before showing all the commands",
    en_US: "Usage:",
    de_DE: "Benutzung:",
    zh_CN: "使用:",
    zh_TW: "用法：",
  ...
  "git-version": {
    __desc__:
      "The git version dummy output, kind of silly. PCOTTLE is my unix name but feel free to put yours instead",
  ...
  "show-command": {
    ...
    zh_CN: "请使用以下命令以了解更多：",
    de_DE:
      "Bitte benutze einen der folgenden Befehle um mehr Informationen zu bekommen:",
    es_AR: "Usá alguno de estos comandos para tener más información:",
    es_MX:
      "Por favor, utilice alguno de estos comandos para tener más información:",
    ...
    fr_FR:
      "Merci d'utiliser une des commandes suivantes pour obtenir plus d'informations",
  ...
  "cd-command": {
    ...
    de_DE:
      'Verzeichnis gewechselt zu "/verzeichnisse/sind/in/dieser/demo/irrelevant"',
    ...
    fr_FR:
      'Répertoire changé à "/directories/dont/matter/in/this/demo" (les répertoires ne servent à rien dans cette démo)',
  ...
  "ls-command": {
    ...
    fr_FR:
      "DontWorryAboutFilesInThisDemo.txt (ne vous préoccupez pas des noms de fichier dans cette démo)",
    ru_RU: "НеНадоЗаботитьсяОФайлахВЭтомДемо.txt",
    uk: "ЗабийНаФайлиВЦьомуДемо.txt",
    ko:
      "DontWorryAboutFilesInThisDemo.txt (이_데모에서_파일에_대한_걱정은_하지마세요.txt)",
    vi:
      "DontWorryAboutFilesInThisDemo.txt (ĐừngLoLắngVềTậpTinTrongBảnGiớiThiệuNày.txt)",
  ...
  "mobile-alert": {
    __desc__:
      "When someone comes to the site on a mobile device, they can not input commands so this is a nasty alert to tell them",
    en_US:
      "LGB can't receive input on mobile, visit on desktop! it's worth it :D",
    de_DE:
      "LGB ist nicht mit mobilen Endgeräten kompatibel, benutz es vom Desktop! Es lohnt sich :D",
    zh_CN: "无法在移动设备/平板上调出键盘 :( 请试试桌面版 :D",
    zh_TW: "無法在行動裝置上叫出鍵盤，請改用桌面版！",
    es_AR:
      "LGB no puede recibir comandos en dispositivos móviles. Visitanos desde una desktop, ¡lo vale! :D",
    es_MX:
      "LGB no puede recibir comandos en dispositivos móviles. Visítanos en una computadora de escritorio u laptop, ¡Vale la pena! :D",
    es_ES:
      "LGB no puede recibir comandos en dispositivos móviles. Visítanos en una computadora de escritorio, ¡lo vale! :D",
    pt_BR:
      "Provavelmente você não vai conseguir digitar comandos no celular, neste caso tente acessar de um computador",
    gl:
      "LGB non pode recibir os comandos nos dispositivos móbiles. Visítanos dende un ordenador de escritorio, ¡paga a pena! :D",
    fr_FR:
      "Impossible de faire apparaître le clavier sur mobile / tablette :( Essayez de passer sur un ordinateur de bureau :D",
    ru_RU: "Мобильные не поддерживаются, зайди с компьютера!",
    uk:
      "LGB не підтримує ввід тексту з мобільного, зайди з компьютера! Це цього варте!",
    ko:
      "LGB는 모바일에서 입력을 받을 수 없습니다. 데스크톱으로 접속하세요! 이것은 가치가 있습니다. :D",
    vi:
      "Đáng tiếc là ứng dụng không thể nhận thông tin từ điện thoại hay máy tính bảng, hãy sử dụng máy tính cá nhân, đáng để bỏ công mà :D",
    sl_SI:
      "LGB ne more sprejeti ukazov na mobilni napravi, obiščite nas na računalinku! Je vredno :D ",
    pl:
  ...
  "share-tree": {
    __desc__:
      "When you export a tree, we want you to share the tree with friends",
    en_US: 'Share this tree with friends! They can load it with "import tree"',
    de_DE:
      'Teile diesen git-Baum mit Freunden! Sie können ihn mit "import tree" laden',
    ...
    pt_BR:
      'Compartilhe esta árvore com seus amigos! Eles podem carregá-la com "import tree"',
    gl:
      '¡Comparte esta árbore cos teus amigos! Eles poden cargalo con "import tree"',
    fr_FR:
      'Partagez cet arbre avec vos amis ! Ils peuvent le charger avec "import tree"',
    ru_RU:
      'Поделись деревом с друзьями! Они могут загрузить его при помощи "import tree"',
    uk:
      'Поділись цим деревом з друзями! Вони зможуть його завантажити за допомогою "import tree"',
    ko:
      '친구들과 이 트리를 공유하세요! 그들은 "import tree"를 사용해 이를 로드할 수 있습니다.',
    vi:
      'Hãy chia sẻ cây này với bạn của mình! Họ có thể dùng "import tree" để tải.',
  ...
  "solved-map-reset": {
    __desc__:
      "When you reset the solved map to clear your solved history, in case someone else wants to use your browser",
    en_US: "Solved map was reset, you are starting from a clean slate!",
    de_DE:
      "Gelöste Karte wurde zurückgesetzt, du fängst mit einem leeren Blatt an!",
    zh_CN: "解决列表已重置，您现在可以从头开始了",
    zh_TW: "過關地圖已經重新設置，您現在從零開始了",
    es_AR:
      "El mapa resuelto fue eliminado, estás arrancando desde un estado limpio",
    es_MX:
      "El mapa resuelto fue eliminado, estás empezando desde un estado limpio",
    es_ES:
      "El mapa resuelto fue eliminado, estás empezando de un estado limpio.",
    pt_BR:
      "Mapa de resolvidos descartado, você está começando com ficha limpa!",
    gl: "O mapa resolto foi eliminado, estás arrancando dende un estado limpo.",
    fr_FR:
      "La carte des niveaux résolus a été effacée, vous repartez de zéro !",
  ...
  "level-cant-exit": {
    ...
    en_US:
      'You are not in a level! You are in a sandbox, start a level with "levels"',
    de_DE:
      'Du bist nicht in einem Level! Du bist im Sandkasten-Modus, starte ein Level mit "levels"',
    zh_CN: '您没在关卡中而是在沙盒中，要开始关卡请输入 "levels"',
    zh_TW: '您沒在關卡中！您在沙盒中，要開始關卡請輸入 "levels"',
    es_AR:
      '¡No estás en un nivel! Estás en el sandbox, comenzá un nivel usando "levels"',
    es_MX:
      '¡No estás en un nivel! Estás en el sandbox, comienza un nivel con "levels"',
    es_ES:
      '¡No estás en un nivel! Estás en el sandbox, comienza un nivel con "levels"',
    pt_BR:
      'Você não está em um nível! Você está no sandbox, comece um nível com "levels"',
    gl:
      '¡Non estás en ningún nivel! Estás nunha caixa de arena, comeza un nivel usando "levels"',
    fr_FR:
      'Vous n\'êtes pas dans un niveau ! Vous êtes dans le mode bac à sable, commencez un niveau avec "levels"',
    ru_RU:
      'Ты не проходишь уровень! Ты в песочнице! Чтобы начать уровень, используй команду "levels"!',
  ...
  "level-no-id": {
    ...
    en_US:
      'A level for that id "{id}" was not found! Opening up a level selection view',
    de_DE:
      'Konnte kein Level mit der ID "{id}" finden! Öffne den Level-Auswahldialog',
    zh_CN: '没找到 id 为 "{id}" 的关卡！打开关卡选择框',
    zh_TW: '找不到 id 為 "{id}" 的關卡！開啟關卡選擇視窗',
    es_AR:
      "No se encontró ningún nivel {id}. Abriendo la vista de selección de niveles...",
    es_MX:
      "No se encontró ningún nivel {id}. Abriendo la vista de selección de niveles...",
    es_ES:
      "No se encontró ningún nivel {id}. Abriendo la vista de selección de niveles...",
    ...
    fr_FR:
      "Le niveau dont l'identifiant est {id} n'a pas été trouvé ! Ouverture de la vue de sélection des niveaux",
    ru_RU: 'Уровень с id "{id}" не найден! Открываю выбор уровней',
    uk: 'Рівень з id "{id}" не знайдений! Відкриваю вибір рівней',
    ko:
      'id "{id}"에 대한 레벨이 존재하지 않습니다. 레벨 선택 화면을 열어보세요.',
    vi: 'Không tìm thấy cấp độ cho định danh "{id}". Mở cửa sổ chọn cấp độ.',
    sl_SI:
      'Stopnja za ta id "{id}" ni bila najdena! Odpiram pogled za izbiro stopnje',
  ...
  "undo-stack-empty": {
    __desc__:
      "The undo command can only undo back until the last time the level was reset or the beginning of the level",
  ...
  "already-solved": {
    ...
    en_US:
      'You have already solved this level, try other levels with "levels" or go back to sandbox with "sandbox"',
    de_DE:
      'Du hast dieses Level bereits gelöst, probier ein anderes Level mit "levels" aus oder geh in den Sandkasten-Modus mit "sandbox"',
    zh_CN:
      '你已经解决了本关，输入 "levels" 尝试其他关卡，或者输入 "sandbox" 回到沙盒中',
    zh_TW:
      '你已經解决了本關，輸入 "levels" 嘗試其他關卡，或者輸入 "sandbox" 回到沙盒中',
    es_AR:
      'Ya resolviste este nivel, probá otros usando "levels" o volvé al sandbox usando "sandbox"',
    es_MX:
      'Ya resolviste este nivel, prueba otros usando "levels" o vuelve al sandbox usando "sandbox"',
    es_ES:
      'Ya resolviste este nivel, prueba otros usando "levels" o vuelve al sandbox usando "sandbox"',
    pt_BR:
      'Você já resolveu este nível, tente outros com "levels" ou volte ao sandbox com "sandbox"',
    gl:
      'Xa resolviches este nivel, proba outros usando "levels" ou volve á caixa de area con "sandbox"',
    fr_FR:
      'Vous avez déjà résolu ce niveau, essayez d\'autres niveaux avec "levels" ou revenez au bac à sable avec "sandbox"',
    ru_RU:
      'Ты уже прошел этот уровень, попробуй пройти другие при помощи команды "levels" или иди в песочницу "sandbox"',
    uk:
      'Ти вже пройшов цей рівень, спробуй інші рівні з "levels" чи повернись в пісочницю з "sandbox"',
    ko:
      '당신은 이미 이 레벨을 해결했습니다. "levels"를 사용하여 다른 레벨에 도전하거나 "sandbox"를 사용하여 샌드박스로 돌아가세요.',
    vi:
      'Bạn đã vượt qua cấp độ này. Thử cấp độ khác với "levels" hoặc dùng "sandbox" để trở lại hộp cát.',
    sl_SI:
      'To stopnjo si že rešil, poizkusi druge stopnje z "levels" ali pojdi nazaj v peskovnik s "sandbox"',
    pl:
  ...
  "command-disabled": {
    ...
    pt_BR:
      "Achou que seria fácil assim? Desabilitamos esse comando durante este nível, só para dificultar ;-)",
  ...
  "share-json": {
    ...
    en_US:
      "Here is the JSON for this level! Share it with someone or send it to me on GitHub",
    de_DE:
      "Hier ist das JSON für dieses Level! Teil es mit jemandem or schick es mir über GitHub",
    zh_CN: "这是一个关卡定义 JSON ！您可以分享它或者发到我的 GitHub 上",
    zh_TW: "這是本關的 JSON！您可以分享給別人，或是送到 GitHub 上給我",
    es_AR:
      "Este es el JSON de este nivel. Compartilo con quien quieras o mandámelo por GitHub",
    es_MX:
      "Este es el JSON de éste nivel. Compártelo con quien quieras o mándamelo por GitHub.",
    es_ES:
      "Este es el JSON de este nivel. Compártelo con quien quieras o mandámelo por GitHub.",
    pt_BR:
      "Aqui está o JSON para este nível! Compartilhe com alguém ou me envie pelo GitHub",
    gl:
      "Este é o JSON deste nivel. Comparteo con quen queiras ou mándao por GitHub",
    fr_FR:
      "Voici le JSON pour ce niveau ! Partagez-le avec quelqu'un ou envoyez-le moi sur GitHub",
    ru_RU:
      "Вот JSON для этого уровня! Поделись им с кем-нибудь или отправь его нам на GitHub",
    uk:
      "Ось JSON для цього рівня! Поділись з кимось чи відправ мені його на GitHub",
    ko:
      "이 레벨을 위한 JSON 데이터가 있습니다! 이를 다른 사람들과 공유하거나 GitHub에서 제게 보내보세요.",
    vi:
      "Đây là chuỗi JSON cho cấp độ này! Hãy chia sẻ với người khắc hoặc với tôi qua GitHub.",
    sl_SI:
      "Tu je JSON za to stopnjo! Deli ga z nekom ali ga pošlji meni na GitHub",
    pl:
  ...
  "want-start-dialog": {
    ...
    de_DE:
      "Du hast noch keinen Einführungs-Dialog geschrieben, willst du einen hinzufügen?",
    ...
    fr_FR:
      "Vous n'avez pas spécifié de dialogue de départ, voulez-vous en ajouter un ?",
  ...
  "want-hint": {
    ...
    de_DE:
      "Du hast noch keinen Hinweis geschrieben, magst du einen hinzufügen?",
  ...
  "prompt-hint": {
    ...
    en_US:
      "Enter the hint for this level, or leave this blank if you do not want to include one",
    de_DE:
      "Gib den Hinweis für dieses Level an, oder lass es leer wenn du keinen hinzufügen willst",
    zh_CN: "请输入关卡提示，如果没有请留空",
    zh_TW: "請輸入關卡提示，或者故意留空",
    es_AR:
      "Ingresá una pista para este nivel, o dejalo en blanco si no querés incluir ninguna",
    es_MX:
      "Ingresa una pista para este nivel, o déjalo en blanco si no quieres incluir ninguna.",
    es_ES:
      "Ingresa una pista para este nivel, o déjalo en blanco si no quieres incluir ninguna.",
    pt_BR:
      "Colocque uma dica para este nível, ou deixe em branco se não quiser incluir",
    gl:
      "Ingresa unha pista para este nivel, ou déixao en branco se non a queres incluír.",
    fr_FR:
      "Entrez l'indice pour ce niveau, ou laissez-le vide pour ne pas l'inclure",
    ru_RU: "Введи подсказку для уровня, если хочешь.",
    uk: "Додай підказку для рівня, якщо хочеш",
    ko:
      "이 레벨을 위한 힌트를 입력하거나 만약 이를 포함시키고 싶지 않을 경우엔 비워두세요.",
    vi:
      "Thêm một gợi ý cho cấp độ này, hoặc cứ để trống nếu bạn không muốn thêm.",
  ...
  "solution-empty": {
    __desc__:
      "If you define a solution without any commands, aka a level that is solved without doing anything",
    ...
    pt_BR:
      "Sua solução está vazia! O aprendiz deveria ter que fazer alguma coisa",
  ...
  "define-start-warning": {
    __desc__:
      "When you define the start point again, it overwrites the solution and goal so we add a warning",
    en_US:
      "Defining start point... solution and goal will be overwritten if they were defined earlier",
    de_DE:
      "Lege Startpunkt fest ... Auflösung und Ziel werden überschrieben, falls sie schon festgelegt waren",
    zh_CN: "定义开始点... 解决方法和目标会被新的替代",
    zh_TW: "正在定義起始點...先前定義的解法和目標會被覆蓋掉",
    es_AR:
      "Estableciendo el punto de inicio... La solución y el objetivo serán sobreescritos si ya habían sido definidos",
    es_MX:
      "Estableciendo el punto de inicio... La solución y el objetivo serán sobreescritos si ya habían sido definidos",
    es_ES:
      "Estableciendo el punto de inicio... La solución y el objetivo serán sobreescritos si ya habían sido definidos.",
    pt_BR:
      "Esbelecendo o ponto de início... a solução e o objetivo serão sobrescritos caso já existirem",
    gl:
      "Establecendo o punto de inicio... A solución e o obxectivo serán sobreescritos se xa foron definidos.",
    fr_FR:
      "Redéfinition du point de départ… la solution et la cible seront écrasés s'ils ont déjà été définis",
    ru_RU:
      "Устанавливаю стартовую точку... Решение и итоговое состояние будут стёрты, если они указаны ранее",
    uk:
      "Встановлюю стартову точку... розв’язок та ціль будуть переписані якщо вони були задані раніше",
    ko:
      "시작 지점을 정의하세요... 만약 그것이 먼저 정의된다면 해답과 목표가 덮어씌워질 것입니다.",
    vi:
      "Xác định điểm bắt đầu ... Các giải pháp và mục tiêu sẽ được thay thế nếu đã được chỉ định từ trước.",
    sl_SI:
      "Določanje začetne točke ... rešitev in cilj bosta povožena, če sta bila prej že podana",
    pl:
  ...
  "help-vague-level": {
    __desc__:
      "When you are in a level and you say help, its vague and you need to specify",
    en_US:
      'You are in a level, so multiple forms of help are available. Please select either "help level" to learn more about this lesson, "help general" for using Learn GitBranching, or "objective" to learn about how to solve the level.',
    de_DE:
      'Du befindest dich in einem Level, daher gibt es verschiedene Hilfen. Gib "help level" ein um mehr úber dieses Level zu erfahren, "help general" um zu sehen wie Learn Git Branching bedient wird, oder "objective" um das Ziel dieses Levels zu erfahren.',
    zh_CN:
      '您正在关卡中，这里有多种形式的帮助，请选择 "help level" (关卡帮助)或 "help general" (一般帮助)',
    zh_TW:
      '您正在進行關卡中，這裡有多種不同型式的幫助，請選擇 "help level" 來了解這個關卡，或者是選擇 "help general" 來學習如何使用 Learn GitBranching，或者是選擇 "objective" 來學習如何解決這個關卡',
    es_AR:
      'Estás en un nivel, por lo que hay varios tipos de ayuda. Por favor elegí entre "help level" para aprender algo más sobre esta lección, "help general" para ayuda sobre el uso de Learn GitBranching, o "objective" para aprender a resolver este nivel.',
    es_MX:
      'Estás en un nivel, por lo que hay varios tipos de ayuda. Por favor elige entre "help level" para aprender algo más sobre ésta lección, "help general" para ayuda sobre el uso de Learn GitBranching, o "objective" para aprender a resolver este nivel.',
    es_ES:
      'Estás en un nivel, por lo que hay varios tipos de ayuda. Por favor elige "help level" para aprender más sobre esta lección, "help general" para ayuda sobre el uso de Learn GitBranching, o "objective" para aprender a resolver este nivel.',
    pt_BR:
      'Você está em um nível, então há vários tipos de ajuda. Selecione "help level" para aprender mais sobre esta lição, "help general" para aprender a usar o Learn GitBranching, ou "objective" ver como resolver o nível.',
    gl:
      'Estás nun nivel, entón hai varios tipos de axuda. Selecione "help level" para aprender máis sobre esta lección, "gelp general" para aprender a usar o Learn Git Branching, ou "objective" para ver como resolver o nivel.',
    fr_FR:
      'Vous êtes dans un niveau, donc plusieurs formes d\'aide sont disponibles. Merci de sélectionner soit "help level" pour en apprendre plus sur cette leçon, "help general" pour l\'utilisation de Learn GitBranching, ou "objective" pour apprendre comment résoudre le niveau',
    ru_RU:
      'При прохождении уровня доступны несколько видов помощи. Определить что нужно: "help level" чтобы получить информацию об этом уровне, "help general" для того, чтобы узнать о игре в целом или "objective" чтобы узнать что надо сделать в этом уровне.',
    uk:
      'При проходженні рівня доступні декілька різновидів допомоги. Виберіть або "help level" щоб взнати більше про цей рівень, чи "help general" щоб взнати більше про Learn Git Branching, чи "objective" щоб дізнатись більше про проходження цього рівня',
    ko:
      '당신은 한 레벨에 들어가 있고, 여러가지 도움 양식들을 사용할 수 있습니다. 레슨에 대해 더 알고싶을 땐 "help level", LearnGitBranching을 사용하고 싶을 땐 "help general", 또는 레벨을 어떻게 해결해야할지 알고싶을 땐 "objective"를 선택하세요.',
    vi:
      'Bạn đang ở trong một cấp độ, nên sẽ có nhiều hỗ trợ. Vui lòng dùng "help level" để biết thêm về bài học này, "help general" để sử dụng HọcNhánhGit, hoặc "objective" để biết cách giải quyết bài tập.',
    sl_SI:
      'Si v stopnji, zato so na voljo različne pomoči. Prosim izberi "help level" za več informacij o tej lekciji, "help general" za splošna navodila ali "objective" da izveš kako rešiti to stopnjo',
    pl:
  ...
  "help-vague-builder": {
    __desc__:
      "When you are in a level builder, the help command is vague so you need to specify what you mean",
    en_US:
      'You are in a level builder, so multiple forms of help are available. Please select either "help general" or "help builder"',
    de_DE:
      'Du befindest dich im Level-Editor, daher gibt es verschiedene Hilfen. Gib bitte "help general" oder "help builder" ein',
    zh_CN:
      '您正在进行关卡构建中，这里有多种形式的帮助，请选择 "help general" (一般帮助)或 "help builder" (关卡构建帮助)',
    zh_TW:
      '您正在進行關卡構建中，這裡有多種不同型式的幫助，請選擇 "help general" （一般幫助）或 "help builder" （製造關卡的幫助）',
    es_AR:
      'Estás en el constructor de niveles, por lo que hay varios tipos de ayuda. Elegí entre "help general" para ayuda sobre Learn GitBranching y "help builder" para ayuda sobre el constructor de niveles',
    es_MX:
      'Estás en el constructor de niveles, por lo que hay varios tipos de ayuda. Elige "help general" para ayuda sobre Learn GitBranching y "help builder" para ayuda sobre el constructor de niveles',
    es_ES:
      'Estás en un constructor de niveles, por lo que hay varios tipos de ayuda. Elige "help general" para ayuda sobre Learn GitBranching o "help builder" para ayuda sobre el constructor de niveles',
    pt_BR:
      'Você está no construtor de nívels, então há vários tipos de ajuda. Selecione "help general" ou "help builder"',
    gl:
      'Estás no constructor de niveis, polo que hai varios tipos de axuda. Elixe "help general" ou "help builder"',
    fr_FR:
      'Vous êtes dans l\'éditeur de niveaux, donc plusieurs formes d\'aide sont disponibles. Merci de sélectionner soit "help general" soit "help builder"',
    ru_RU:
      'При создании уровней доступны несколько видов помощи. Выбери между "help general" и "help builder"',
    uk:
      'При створенні рівня доступні декілька різновидів допомоги. Виберіть або "help general", чи "help builder"',
    ko:
      '당신은 한 레벨 생성기에 들어가 있고, 여러가지 도움 양식들을 사용할 수 있습니다. "help general" 또는 "help builder"를 선택해주세요.',
    vi:
      'Bạn đang tạo một cấp độ, nên sẽ có nhiều trợ giúp có sẵn. Vui lòng chọn "help general" hoặc "help builder".',
    sl_SI:
      'Si v graditelju stopenj, zato so na voljo različne pomoči. Prosim izberi "help general" ali "help builder"',
    pl:
  ...
  "goal-only-main": {
    __desc__:
      "the helper message for the window that shows the goal tree when the goal will only be compared using the main branch",
    en_US:
      '<span class="fwber">Note:</span> Only the main branch will be checked in this level. The other branches are simply for reference (shown as dashed labels below). As always, you can hide this dialog with "hide goal"',
    fr_FR:
      '<span class="fwber">Note:</span> Dans ce niveau on ne doit faire de git checkout que sur la branche main. Les autres branches représentées ici (entourées d\'un cadre en tirets) doivent être utilisées uniquement comme références. Comme toujours, vous pouvez cacher cette fenêtre avec "Cacher les objectifs"',
    de_DE:
      '<span class="fwber">Hinweis:</span> In diesem Level wird nur der Branch main geprüft. Die anderen Branches dienen nur als Vergleichsbasis (als gestrichelte Bezeichner dargestellt). Wie immer kannst du diese Meldung mit "hide goal" ausblenden',
    es_AR:
      '<span class="fwber">Nota:</span> Sólo la rama main va a ser chequeada en este nivel. Las otras ramas sólo son para referencia. Como siempre, podés ocultar este mensaje con "hide goal"',
    es_MX:
      '<span class="fwber">Nota:</span> Sólo la rama main va a ser inspeccionada en este nivel. Las otras ramas sólo son para referencia (etiquetados abajo con guión). Como siempre, puedes ocultar éste mensaje con "hide goal"',
    es_ES:
      '<span class="fwber">Nota:</span> Sólo la rama main va a ser inspeccionado en este nivel. Las otras ramas sólo son para referencia (etiquetados abajo con guion). Siempre puedes ocultar este mensaje con "hide goal."',
    pt_BR:
      '<span class="fwber">Nota:</span> Apenas o ramo main será verificado neste nível. Os outros ramos (dentro das caixas clareadas) são somente para referência. Como sempre, você pode ocultar esta janela com "hide goal"',
    gl:
      '<span class="fwber">Nota:</span> Só a rama main será verificada neste nivel. As outras ramas (dentro das caixas clareadas) son soamente de referencia. Coma sempre, podes ocultar está ventá con "hide goal"',
    zh_CN:
      '<span class="fwber">注意:</span>本关卡中，只检查 main 分支，其他分支只是用作 reference 存在（以虚线标签表示）。照常，你可以用 “hide goal” 来隐藏此窗口。',
    zh_TW:
      '在這個關卡中，只有 main branch 會被檢查，別的 branch 只是用來做為 reference （下面用虛線符號表示）。一如往常，你可以利用 "hide goal" 來隱藏這個對話視窗',
    ja:
      '<span class="fwber">Note:</span> mainブランチだけをこのlevelではチェックします。その他のブランチ（以下では、破線で示されています）に関しては、参照のためにあります。また、いつでもこのウィンドウは"hide goal"と打つかクリックで閉じれます',
    ru_RU:
      '<span class="fwber">Важно:</span> В этом уровне проверяется только ветка main. Остальные ветки просто для наглядности. Как обычно, можно скрыть это сообщение при помощи "hide goal"',
    uk:
      '<span class="fwber">Важливо:</span> В цьому рівні буде перевірятися тільки гілка main. Решта гілок тільки для наглядності (показані пунктиром нижче). Як завжди, можна сховати цей діалог за допомогою "hide goal"',
    ko:
      '<span class="fwber">Note:</span> 이 레벨에선 오직 메인 브랜치만이 검사될 것입니다.. 다른 브랜치들은 단순히 참고용입니다. (아래에 대시 라벨로 보여집니다.). "hide goal"을 사용하여 언제든지 창을 숨길 수 있습니다.',
    vi:
      '<span class="fwber">Chú ý:</span> Ở cấp độ này chỉ nhánh main bị kiểm tra. Các nhánh khác chỉ dùng để tham chiếu(có dấu - ở nhãn). Như thường lệ, bạn có thể ẩn mục tiêu bằng "hide goal".',
    sl_SI:
      '<span class="fwber">Opomba:</span> Samo main branch bo preverjen v tej stopnji. Ostali branchi so zgolj za referenco (prikazani kot črtaste oznake spodaj). Kot ponavadi, lahko skriješ dialog z "hide goal"',
    pl:
  ...
  "hide-start": {
    __desc__:
      "The helper message for the window that shows the start tree for a level",
  ...
  "no-start-dialog": {
    __desc__:
      "when the user tries to open a start dialog for a level that does not have one",
  ...
  "error-untranslated-key": {
    __desc__:
      "This error happens when we are trying to translate a specific key and the locale version is mission",
    en_US:
      "The translation for {key} does not exist yet :( Please hop on github and offer up a translation!",
    de_DE:
      "Die Übersetzung für {key} existiert noch nicht :( Falls du eine hast, dann teile sie mir bitte auf GitHub mit!",
    zh_CN: "还没翻译 {key} :( 请在 GitHub 上贡献您的翻译!",
    zh_TW: "還沒翻譯 {key} :( 請在 GitHub 上貢獻您的翻譯!",
    es_AR:
      "Aún no hay traducción para {key} :( ¡Metete en GitHub y sugerí una! :)",
    es_MX:
      "Aún no existe una traducción para {key}. :( ¡Métete en GitHub y sugiere una! :)",
    es_ES:
      "Aún no hay traducción para {key}. :( ¡Métete en GitHub y sugiere una! :)",
    pt_BR: "Não existe tradução para {key} :( Pule no GitHub e sugira uma! :)",
    gl:
      "Non existe tradución para {key} :( Axúdanos en GitHub e suxire unha! :)",
    fr_FR:
      "La traduction pour {key} n'existe pas encore :( Venez sur GitHub pour en offrir une !",
    ja:
      "{key}の翻訳がまだ存在しません :( GitHubでの、翻訳の協力をお願いします m(_)m",
    ru_RU:
      "Перевода для {key} не создано :( Пожалуйста, предложи перевод на GitHub",
    uk:
      "Немає перекладу для {key} :( Будь-ласка, запропонуй переклад на GitHub",
    ko: "{key}를 위한 번역은 아직 존재하지 않습니다 :( 번역에 참여해주세요!",
    vi:
      "Bản dịch cho {key} không có rồi :( Nếu có thể thì hãy lên dự án của chúng tôi ở GitHub để cung cấp bản dịch!",
  ...
  "error-untranslated": {
    __desc__:
      "The general error when we encounter a dialog that is not translated",
    en_US:
      "This dialog or text is not yet translated in your locale :( Hop on github to aid in translation!",
    de_DE:
      "Dieser Dialog oder Text ist noch nicht in deiner Sprache verfügbar. :( Schau auf GitHub vorbei um bei der Übersetzung zu helfen!",
    zh_CN: "这段对话还没有被翻译成您的语言 :( 欢迎在 GitHub 上贡献您的翻译!",
    zh_TW: "這段對話尚未翻成您的語言 :( 歡迎到 GitHub 貢獻翻譯！",
    es_AR:
      "Este mensaje o texto aún no fue traducido a tu idioma :( ¡Metete en GitHub y ayudanos a traducirlo!",
    es_MX:
      "Este mensaje o texto aún no ha sido traducido en tu idioma. :( ¡Métete en GitHub y ayúdanos a traducirlo!",
    es_ES:
      "Este mensaje o texto aún no fue traducido a tu idioma. :( ¡Métete en GitHub y ayúdanos a traducirlo!",
    pt_BR:
      "Esta mensagem ou texto não foi traduzida para Português :( Ajude-nos a traduzir no GitHub!",
    gl:
      "Esta mensaxe ou texto non foi traducida ó teu idioma :( Axúdanos a traducir a web en GitHub, é moi doado!",
    fr_FR:
      "Ce message n'a pas encore été traduit dans votre langue :( Venez sur GitHub aider à la traduction !",
    ja:
      "このダイアログ、またはテキストの翻訳がまだ存在しません :( GitHubでの、翻訳の協力をお願いします m(_)m",
    ru_RU:
      "Для этого сообщения нет перевода :( Пожалуйста, предложи перевод на GitHub",
    uk:
      "Для цього повідомлення ще немає перекладу :( Будь-ласка, запропонуй переклад на GitHub",
    ko:
      "이 대화창이나 텍스트는 아직 번역되지 않았습니다. :( 번역에 참여해주세요!",
    vi:
      "Hội thoại hoặc văn bản này chưa được dịch ra ngôn ngữ của bạn rồi. :( Hãy lên GitHub để cung cấp bản dịch!",
    sl_SI:
      "Ta dialog ali tekst še ni preveden za tvoj jezik :( Skoči na github in dodaj prevod!",
    pl:
  ...
  "error-command-currently-not-supported": {
    __desc__:
      "Message that appears in git console when command is not supported in the current environment.",
    en_US:
      "That command is valid, but not supported in this current environment! Try entering a level or level builder to use that command",
    zh_TW:
