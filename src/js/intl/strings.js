exports.strings = {
  ...
  "git-error-origin-push-no-ff": {
    ...
    "fa": "مخزن ریموت با مخزن محلی فرق کرده، پس بارگذاری تغییراتت یک fast forward ساده نیست (و پس push شما رد شد). تغییرات جدید مخزن ریموت رو pull کن، توی این شاخه ادغام کن و دوباره امتحان کن. می‌تونی این کار رو با git pull یا git pull --rebase انجام بدی.",
