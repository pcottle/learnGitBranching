exports.level = {
  ...
  startTree:
    '{"branches":{"main":{"target":"C7","id":"main"}},"commits":{"C0":{"parents":[],"id":"C0","rootCommit":true},"C1":{"parents":["C0"],"id":"C1"},"C2":{"parents":["C1"],"id":"C2"},"C3":{"parents":["C1"],"id":"C3"},"C4":{"parents":["C3"],"id":"C4"},"C5":{"parents":["C2"],"id":"C5"},"C6":{"parents":["C4","C5"],"id":"C6"},"C7":{"parents":["C6"],"id":"C7"}},"HEAD":{"target":"main","id":"HEAD"}}',
  name: {
    ...
    zh_CN: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["现在来试试选择另一个 parent 提交……"],
            afterMarkdowns: ["看见了吧？我们回到了另外一个 parent 提交上。"],
            command: "git checkout main^2",
            beforeCommand:
              "git checkout HEAD^; git commit; git checkout main; git merge C2",
          },
      ...
      childViews: [
        ...
        },
        {
          ...
          options: {
            ...
            afterMarkdowns: ["Fácil -- esto es algo habitual."],
            command: "git checkout main^",
            beforeCommand:
              "git checkout HEAD^; git commit; git checkout main; git merge C2",
          },
    ...
    pl: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["A teraz spróbujmy określić drugiego rodzica..."],
