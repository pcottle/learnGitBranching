...
var sequenceInfo = exports.sequenceInfo = {
  ...
  remote: {
    ...
    about: {
      ...
      'es_AR': 'Hora de compartir sus 1\'s y 0\'s, chic@s; programar se volvió social!',
  ...
  move: {
    ...
    about: {
      ...
      'es_AR': 'Ponete cómod@ con modificar el directorio fuente',
  ...
  advanced: {
    ...
    about: {
      ...
      'es_AR': '¡Para l@s verdader@s valientes!',
