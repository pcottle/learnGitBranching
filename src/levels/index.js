...
var sequenceInfo = (exports.sequenceInfo = {
  ...
  rampup: {
    ...
    about: {
      ...
      es_AR:
        "La próxima porción de 100% maravillas git. Espero que estés hambriento",
      ...
      pl:
        "Następna porcja GIT-a jest niesamowita. Mam nadzieję, że jesteś głodny",
      ta_IN:
        "அடித்தது கிட்டின் 100% அற்புதங்கள். நீங்கள் ஆர்வமாக உள்ளீர்கள் என்று நம்புகிறேன்",
  ...
  remote: {
    ...
    about: {
      ...
      fr_FR:
        "C'est le temps de partager vos 1 et vos 0 les enfants, le code vient de devenir social.",
      ja: "自分のコードをより広く公開しましょう",
      de_DE: "Zeit eure 1en und 0en zu teilen; Coding mit sozialer Komponente",
      es_AR:
        "Hora de compartir sus 1's y 0's, chicos; programar se volvió social!",
      es_MX:
        "Hora de compartir sus 1's y 0's, chicos; programar se volvió social!",
      es_ES:
      ...
      gl:
        "Hora de compartilos seus 1' e 0's, rapaces; programar agora é social!",
      zh_CN: "是时候分享你的代码了，让编码变得社交化吧",
      zh_TW: "是時候分享你的程式碼了",
      ru_RU:
        "Настало время поделиться своими единичками и нулями. Время коллективного программирования",
      uk:
        "Настав час поділитися своїми нулями та одиничками; соціальне програмування",
      ko: "내 코드를 공개할 때가 되었습니다. 코드를 공개해봅시다!",
      vi:
        "Chia sẻ đứa con tinh thần '0' và '1' của bạn; mã đã đến với cộng đồng",
      sl_SI:
        "Čas za deljenje tvojih 1 in 0; kodiranje je pravkar postalo socialno",
      pl:
        "Czas podzielić się swoimi dziećmi 1 i 0; kodowanie właśnie stało się społeczne",
      ta_IN:
        "உங்களின் 1'கள் மற்றும் 0'களை பகிர்வதற்கான நேரம் குழந்தைகளே; குறியிடுதல் (coding) பொது உடமை ஆக்க பட்டுள்ளது",
      it_IT:
  ...
  remoteAdvanced: {
    ...
    about: {
      ...
      fr_FR:
        "Et vous pensiez qu'être un dictateur bienfaisant serait amusant...",
      ja: "絶えず上級者の仕事は存在する。。。",
      ...
      pt_BR:
        "E você achava que ser um déspota esclarecido seria mais divertido...",
