      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Great! You now know how to commit and branch. Next: how to combine the work from two different branches together. Knowing this will allow you to branch off, develop a new feature, and then join it back to the main line of development.",
              "",
              "First we'll show you `git merge`. Merging in Git creates a special commit that has two unique parents. A commit with two parents essentially means \"I want to inherit from all the work from this parent and that parent, *and* all their parents.\"",
              "",
        ...
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "Here we have two branches; each points to one commit. This means that neither branch points to the \"work history\". Let's fix that with merge.",
              "",
            ...
            "afterMarkdowns": [
              ...
              "",
              "Also, see how the colors of the commits changed? To help you see what happened, I color-coded the commits. Each branch gets one color. The commits' colors are a blend of all branches that contain that commit.",
              "",
              "So here we see that the `master` branch color (purple) is blended into all the commits, but the `bugFix` color (pink) is not. Let's fix that..."
            ],
        ...
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "Let's merge `bugFix` into `master`:"
            ],
            "afterMarkdowns": [
              "Since `bugFix` was an ancestor of `master`, git didn't have to do anything to the snapshots; it just moved the `bugFix` pointer to the same commit `master` was attached to.",
              "",
              "Now all the commits are the same color, which means both branches contain the entire repository history. Woohoo!"
            ],
