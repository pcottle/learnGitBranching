exports.level = {
  goalTreeString:
    '{"branches":{"master":{"target":"C4","id":"master"},"bugFix":{"target":"C2","id":"bugFix"}},"commits":{"C0":{"parents":[],"id":"C0","rootCommit":true},"C1":{"parents":["C0"],"id":"C1"},"C2":{"parents":["C1"],"id":"C2"},"C3":{"parents":["C1"],"id":"C3"},"C4":{"parents":["C3","C2"],"id":"C4"}},"HEAD":{"target":"master","id":"HEAD"}}',
  solutionCommand:
  ...
  hint: {
    ...
    de_DE:
      "Denk dran in der angegebenen Reihenfolge zu committen (erst bugFix, dann main)",
    ja: "指示された順番でコミットすること（masterの前にbugFixで）",
    es_AR:
      "Acordate de commitear en el orden especificado (bugFix antes de main)",
    es_MX:
      "Acuérdate de hacer commit en el orden especificado (bugFix antes de main)",
    es_ES:
      "Acuérdate de hacer commit en el orden especificado (bugFix antes de main)",
    ...
    fr_FR:
      "Pensez à faire des commits dans l'ordre indiqué (bugFix avant main)",
    zh_CN: "要按目标窗口中指定的顺序进行提交（bugFix 先于 main）",
    zh_TW: "記住按指定的順序 commit（bugFix 比 main 優先）",
    ko: "말씀드린 순서대로 커밋해주세요 (bugFix에 먼저 커밋하고 main에 커밋)",
    ru_RU:
      "Не забудь делать коммиты в правильном порядке (сначала bugFix, потом main)",
    uk:
      "Не забудь робити коміти в правильному порядку (спочатку bugFix, а вже потім main)",
    vi: "Nhớ là commit theo đúng thứ tự(bugFix trước main)",
    sl_SI:
      "Zapomni si, da je potrebno commitati v pravilnem vrstnem redu (bugfix pred main)",
    pl: "Pamiętaj, aby commit-ować w określonej kolejności (bugFix przed main)",
    ta_IN:
      "bugFix முன் main என்ற கொடுக்கப்பட்ட வரிசையில் கட்டலை இடுவதை கருத்தில் கொள்க",
    it_IT:
    ...
    en_US: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Let's merge `main` into `bugFix`:"],
            afterMarkdowns: [
    ...
    de_DE: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Mergen wir `main` in `bugFix`:"],
            afterMarkdowns: [
    ...
    es_AR: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Mergeemos `main` a `bugFix`:"],
            afterMarkdowns: [
    ...
    es_ES: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Hagamos merge de `main` a `bugFix`:"],
            afterMarkdowns: [
              "Como `bugFix` era un ancestro de `main`, git no tuvo que hacer ningún trabajo; simplemente movió `bugFix` al mismo commit al que estaba anexado `main`.",
              "",
    ...
    pt_BR: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Vamos juntar o `main` no `bugFix`:"],
            afterMarkdowns: [
    ...
    gl: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Imos mesturar a rama `main` en `bugFix`:"],
            afterMarkdowns: [
    ...
    fr_FR: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Faisons un merge  de `main` dans `bugFix`:"],
            afterMarkdowns: [
    ...
    zh_CN: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["咱们再把 `main` 分支合并到 `bugFix`："],
            command: "git checkout bugFix; git merge main",
            afterMarkdowns: [
    ...
    zh_TW: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["讓我們 merge  `main` branch 到 `bugFix` 吧。"],
            command: "git checkout bugFix; git merge main",
            afterMarkdowns: [
    ...
    ru_RU: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Смерджим ветку `main` в ветку `bugFix`."],
            afterMarkdowns: [
    ...
    uk: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Давай змержимо `main` в `bugFix`:"],
            afterMarkdowns: [
    ...
    vi: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Hãy gộp nhánh `main` vào `bugFix` nào:"],
            afterMarkdowns: [
    ...
    sl_SI: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Zmergajmo sedaj `main` v `bugFix`:"],
            afterMarkdowns: [
    ...
    pl: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Połączmy brach `main` z branch `bugFix`:"],
            afterMarkdowns: [
    ...
    ta_IN: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["`main`-ஐ `bugFix` உடன் இணைப்போம்:"],
            afterMarkdowns: [
      ...
      childViews: [
        {
          ...
          options: {
            markdowns: [
              "## Rami e fusione",
              "",
              "Ottimo! Ora sappaimo come funzionano i commit e i rami. Adesso dobbiamo imparare in modo da unire il lavoro di due rami diversi. Questo ci permettera di creare un nuovo ramo, aggiungere una nuova funzionalità, e poi riunire il tutto.",
              "",
