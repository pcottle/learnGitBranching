exports.level = {
  ...
  hint: {
    ...
    es_AR:
      "Simplemente commiteá una vez en bugFix cuando estés listo para seguir",
    es_ES:
      "Simplemente crea un commit en la rama bugFix cuando estés listo para seguir",
    pt_BR:
      "Simplesmente commite uma vez em bugFix quando quiser parar de experimentar",
    ...
    sl_SI: {
      childViews: [
        ...
        },
        {
          type: "GitDemonstrationView",
          options: {
            beforeMarkdowns: ["Poglejmo hiter primer. Za drevo spodaj:"],
            afterMarkdowns: [
