exports.level = {
  ...
  startTree:
    '{"branches":{"master":{"target":"C1","id":"master"},"debug":{"target":"C2","id":"debug"},"printf":{"target":"C3","id":"printf"},"bugFix":{"target":"C4","id":"bugFix"}},"commits":{"C0":{"parents":[],"id":"C0","rootCommit":true},"C1":{"parents":["C0"],"id":"C1"},"C2":{"parents":["C1"],"id":"C2"},"C3":{"parents":["C2"],"id":"C3"},"C4":{"parents":["C3"],"id":"C4"}},"HEAD":{"target":"bugFix","id":"HEAD"}}',
  name: {
    ko: "딱 한 개의 커밋만 가져오기",
  ...
  hint: {
    ...
    de_DE:
      "Vergiss nicht: hier kommst du mit interaktivem Rebase oder Cherry-Picking weiter",
    fr_FR:
      "Souvenez-vous, les rebases interactifs ou cherry-pick sont vos amis ici.",
    ...
    pt_BR:
      "Lembre-se, o rebase interativo ou o cherry-pick são seus amigos aqui",
    gl:
      "Recorda, o rebase interativo ou cherry-pick é un dos teus colegas aquí",
    ja:
    ...
    ru_RU:
      "Не забывай, что интерактивный rebase и cherry-pick – это твои друзья!",
    uk: "Не забувай, що інтерактивний rebase та cherry-pick -- це твої друзі!",
    vi: "Hãy nhớ 2 anh bạn tương tác rebase và cherry-pick!",
    sl_SI:
      "Pomni, interaktivni rebase ali cherry-pick sta tu tvoja prijatelja.",
    pl:
      "Pamiętaj, interaktywny rebase oraz cherry-picking są tu twoimi przyjaciółmi",
