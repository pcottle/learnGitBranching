    ...
    "de_DE": {
      "childViews": [
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "Dieses Level hat also wieder das Ziel, den Commit `C2` zu modifizieren, diesmal aber ohne `git rebase -i` zu benutzen. Ich überlass es dir herauszufinden, wie das gehen soll. :D",
              "",
