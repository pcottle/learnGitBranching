exports.level = {
  ...
  startTree:
    '{"branches":{"master":{"target":"C1","id":"master"},"newImage":{"target":"C2","id":"newImage"},"caption":{"target":"C3","id":"caption"}},"commits":{"C0":{"parents":[],"id":"C0","rootCommit":true},"C1":{"parents":["C0"],"id":"C1"},"C2":{"parents":["C1"],"id":"C2"},"C3":{"parents":["C2"],"id":"C3"}},"HEAD":{"target":"caption","id":"HEAD"}}',
  ...
  hint: {
    ...
    pt_BR:
      "Não se esqueça de avançar a referência do main para as mudanças efetuadas!",
      ...
      childViews: [
        ...
        },
        {
          ...
          options: {
            ...
            afterMarkdowns: ["Odlično! Nadaljujmo ..."],
            command: "git cherry-pick C2",
            beforeCommand:
              "git checkout -b bugFix; git commit; git checkout main; git commit",
          },
      ...
      childViews: [
        ...
        },
        {
          ...
          options: {
            ...
            afterMarkdowns: ["Ładnie! Ruszajmy dalej."],
            command: "git cherry-pick C2",
            beforeCommand:
              "git checkout -b bugFix; git commit; git checkout main; git commit",
          },
