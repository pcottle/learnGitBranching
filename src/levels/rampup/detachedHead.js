exports.level = {
  goalTreeString:
    '{"branches":{"master":{"target":"C2","id":"master"},"bugFix":{"target":"C4","id":"bugFix"}},"commits":{"C0":{"parents":[],"id":"C0","rootCommit":true},"C1":{"parents":["C0"],"id":"C1"},"C2":{"parents":["C1"],"id":"C2"},"C3":{"parents":["C1"],"id":"C3"},"C4":{"parents":["C3"],"id":"C4"}},"HEAD":{"target":"C4","id":"HEAD"}}',
  solutionCommand: "git checkout C4",
  startTree:
    '{"branches":{"master":{"target":"C2","id":"master"},"bugFix":{"target":"C4","id":"bugFix"}},"commits":{"C0":{"parents":[],"id":"C0","rootCommit":true},"C1":{"parents":["C0"],"id":"C1"},"C2":{"parents":["C1"],"id":"C2"},"C3":{"parents":["C1"],"id":"C3"},"C4":{"parents":["C3"],"id":"C4"}},"HEAD":{"target":"bugFix","id":"HEAD"}}',
  name: {
      ...
      childViews: [
        ...
        },
        {
          ...
          options: {
            ...
            afterMarkdowns: ["看吧！HEAD 一直藏在 `main` 分支的後面。"],
            command:
              "git checkout C1; git checkout main; git commit; git checkout C2",
            beforeCommand: "",
          },
      ...
      childViews: [
        ...
        },
        {
          ...
          options: {
            ...
            afterMarkdowns: ["Thấy chứ? HEAD đã ẩn dưới nhánh `main` suốt."],
            command:
              "git checkout C1; git checkout main; git commit; git checkout C2",
            beforeCommand: "",
          },
      ...
      childViews: [
        ...
        },
        {
          ...
          options: {
            ...
            afterMarkdowns: ["Sedaj pa je takole:", "", "HEAD -> C1"],
            command: "git checkout C1",
            beforeCommand: "",
          },
        },
      ...
      childViews: [
        ...
        },
        {
          ...
          options: {
            ...
            afterMarkdowns: ["A tak po:", "", "HEAD -> C1"],
            command: "git checkout C1",
            beforeCommand: "",
          },
        },
