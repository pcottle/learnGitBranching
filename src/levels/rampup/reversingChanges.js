exports.level = {
  ...
  startTree:
    '{"branches":{"master":{"target":"C1","id":"master"},"pushed":{"target":"C2","id":"pushed"},"local":{"target":"C3","id":"local"}},"commits":{"C0":{"parents":[],"id":"C0","rootCommit":true},"C1":{"parents":["C0"],"id":"C1"},"C2":{"parents":["C1"],"id":"C2"},"C3":{"parents":["C1"],"id":"C3"}},"HEAD":{"target":"local","id":"HEAD"}}',
  name: {
  ...
  hint: {
    ...
    de_DE:
      "Beachte, dass revert und reset unterschiedliche Argumente benötigen",
    ...
    vi:
      "Lưu ý rằng hoàn tác(revert) và đặt lại(reset) có những đối số khác nhau.",
    sl_SI: "Revert in reset sprejmeta različne argumente.",
    pl: "Zauważ, że revert i reset przyjmują różne argumenty",
    it_IT: "Attento che revert e reset hanno parametri diversi.",
  },
  startDialog: {
    en_US: {
      childViews: [
