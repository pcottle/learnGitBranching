exports.level = {
  ...
  name: {
    ...
    it_IT: "Rebasing oltre 9000 volte", //vegeta reference? in italy is't 8000 (like in japanese. yep, I've made some research..)
  },
  hint: {
    en_US:
      "Remember, the most efficient way might be to only update main at the end...",
    de_DE:
      "Nicht vergessen: nur den main zu aktualisieren könnte die effizienteste Möglichkeit sein ...",
    es_AR:
      "Acordate, la manera más eficiente podría ser actualizar main sólo al final...",
    es_ES:
      "Recuerda, la manera más eficiente podría ser actualizar main sólo al final...",
    pt_BR:
      "Lembre-se, a forma mais eficiente pode ser atualizar o main por último...",
    gl:
      "Lembra, a forma máis eficiente pode ser actualizar a rama main ó final...",
    fr_FR:
      "Rappelez-vous, la façon la plus efficace peut être de mettre à jour main seulement à la fin ...",
    ja: "最も効率的なやり方はmasterを最後に更新するだけかもしれない・・・",
    ko:
      "아마도 main을 마지막에 업데이트하는 것이 가장 효율적인 방법일 것입니다...",
    ...
    vi:
      "Hãy nhớ rằng, cách tốt nhất có lẽ là nên cuối cùng mới cập nhật nhánh `main`... ",
    sl_SI:
      "Pomni, morda je najbolj učinkovit način posodabljanje masterja samo na koncu ...",
    pl:
