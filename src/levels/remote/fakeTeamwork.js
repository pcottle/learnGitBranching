exports.level = {
  ...
  "hint": {
    ...
    "uk": "пам’ятайте, що Ви можете вказати кількість фейкових комітів",
      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Це означає, що нам треба \"вдавати\", що віддалений репозиторій був модифікований Вашим колегою / друзями / небайдужими, іноді на специфічній гілці чи коміті.",
              "",
        ...
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "Ви також можете вказати кількість комітів чи гілку, в яку потрібно додати коміти."
            ],
            "afterMarkdowns": [
