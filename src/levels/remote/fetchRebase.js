exports.level = {
  ...
  "hint": {
    ...
    "fa": "ترتیب را از تجسم هدف بررسی کنید",
    ...
    "bg": "Провери реда в визуализацията на целта",
      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              "## کار واگرا",
              "",
              "تاکنون دیده‌ایم که چگونه کامیت‌های دیگران را `pull` کنیم و چگونه تغییرات خودمان را `push` کنیم. به نظر بسیار ساده می‌رسد، پس چگونه ممکن است افراد گیج شوند؟",
              "",
              "مشکل زمانی پیش می‌آید که تاریخچه مخزن *واگرا* می‌شود (از هم جدا می‌شود). قبل از بحث در مورد جزئیات این موضوع، بیایید یک مثال ببینیم...",
              ""
            ]
          }
        },
        {
          ...
          "options": {
            "markdowns": [
              "تصور کنید روز دوشنبه یک مخزن را کلون می‌کنید و شروع به کار روی یک ویژگی جانبی می‌کنید. تا جمعه آماده‌اید ویژگی خود را منتشر کنید -- اما وای نه! همکاران شما در طول هفته کلی کد نوشته‌اند که باعث شده ویژگی شما قدیمی (و منسوخ) شود. آن‌ها همچنین این کامیت‌ها را در مخزن ریموت مشترک منتشر کرده‌اند، بنابراین اکنون کار *شما* بر اساس یک نسخه *قدیمی* از پروژه است که دیگر مرتبط نیست.",
              "",
              "در این مورد، دستور `git push` مبهم است. اگر `git push` را اجرا کنید، آیا گیت باید مخزن ریموت را به آنچه در روز دوشنبه بود برگرداند؟ آیا باید سعی کند کد شما را اضافه کند در حالی که کد جدید را حذف نمی‌کند؟ یا آیا باید تغییرات شما را کاملاً نادیده بگیرد زیرا کاملاً قدیمی هستند؟",
              "",
              "از آنجا که در این وضعیت (که تاریخچه واگرا شده است) ابهام زیادی وجود دارد، گیت به شما اجازه نمی‌دهد تغییرات خود را `push` کنید. در واقع شما را مجبور می‌کند قبل از اینکه بتوانید کار خود را به اشتراک بگذارید، آخرین وضعیت ریموت را ترکیب کنید."
            ]
          }
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "چقدر حرف زدیم! بیایید این وضعیت را در عمل ببینیم."
            ],
            "afterMarkdowns": [
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "چگونه این وضعیت را حل می‌کنید؟ آسان است، تنها کاری که باید انجام دهید این است که کار خود را بر اساس جدیدترین نسخه شاخه ریموت قرار دهید.",
              "",
              "چند راه برای انجام این کار وجود دارد، اما مستقیم‌ترین راه انتقال کار شما از طریق rebasing است. بیایید برویم و ببینیم چه شکلی است."
            ]
          }
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "حالا اگر به جای آن قبل از push کردن rebase کنیم..."
            ],
            "afterMarkdowns": [
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "آیا راه‌های دیگری برای به‌روزرسانی کار من وقتی مخزن ریموت به‌روز شده است وجود دارد؟ البته! بیایید همان کار را اما این بار با `merge` بررسی کنیم.",
              "",
              "اگرچه `git merge` کار شما را جابجا نمی‌کند (و در عوض فقط یک کامیت ادغام ایجاد می‌کند)، این راهی است برای اینکه به گیت بگویید تمام تغییرات ریموت را ترکیب کرده‌اید. این به این دلیل است که شاخه ریموت اکنون *جد* شاخه خودتان است، به این معنی که کامیت شما تمام کامیت‌های شاخه ریموت را منعکس می‌کند.",
              "",
        ...
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "حالا اگر به جای rebase کردن ادغام کنیم..."
            ],
            "afterMarkdowns": [
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "عالی! آیا راهی وجود دارد که بتوانم این کار را بدون تایپ کردن این همه دستور انجام دهم؟",
              "",
              "البته -- شما قبلاً می‌دانید که `git pull` فقط خلاصه‌ای برای یک fetch و یک merge است. به اندازه کافی راحت، `git pull --rebase` خلاصه‌ای برای یک fetch و یک rebase است!",
              "",
              "بیایید این دستورات خلاصه را در کار ببینیم."
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "این جریان کاری fetch، rebase/merge و push کردن بسیار رایج است. در درس‌های آینده نسخه‌های پیچیده‌تری از این جریان‌های کاری را بررسی خواهیم کرد، اما فعلاً بیایید این را امتحان کنیم.",
              "",
              "برای حل این مرحله، مراحل زیر را انجام دهید:",
              "",
              "* مخزن خود را کلون کنید",
              "* مقداری کار تیمی جعلی انجام دهید (1 کامیت)",
              "* خودتان مقداری کار کامیت کنید (1 کامیت)",
              "* کار خود را از طریق *rebasing* منتشر کنید"
            ]
          }
        }
      ]
    ...
    "pt_BR": {
      "childViews": [
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "Como resolver essa situação? É fácil, tudo que você precisa fazer é basear seu trabalho na versão mais recente da branch remota.",
              "",
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Embora o `git merge` não mova o seu trabalho (em vez disso, ele cria um commit de merge), ele é uma forma de contar ao Git que você incorporou todas as mudanças do repositório remoto. Isso acontece porque a branch remota passa a ser um *ancestral* da sua própria branch, significando que o seu commit reflete todos os commits contidos na branch remota.",
              "",
      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              "## Разделена работа",
              "",
              "Досега видяхме как да `pull`-ваме комити от други хора и как да `push`-ваме собствените си промени. Изглежда доста просто — тогава защо толкова хора се объркват?",
              "",
              "Трудностите започват, когато историята на хранилището *се раздели*. Преди да навлизаме в детайлите, нека първо видим един пример...",
              ""
            ]
          }
        },
        {
          ...
          "options": {
            "markdowns": [
              "Представи си, че клонираш хранилище в понеделник и започваш да работиш по странична функционалност. В петък вече си готов да публикуваш работата си — но уви! Колегите ти са написали доста код през седмицата и твоята функционалност вече е остаряла (и дори ненужна).",
              "",
              "Те вече са публикували тези комити в споделеното отдалечено хранилище, така че сега *твоята* работа е базирана на *стара* версия на проекта, която вече не е актуална.",
              "",
              "В този случай командата `git push` е двусмислена. Ако я изпълниш, трябва ли Git да върне отдалеченото хранилище в състоянието му от понеделник? Да се опита да добави твоя код, без да премахва новия? Или напълно да игнорира промените ти, защото вече не са релевантни?",
              "",
              "Поради тази неяснота (когато историята се е разделила), Git не ти позволява да `push`-неш промените си. Вместо това те принуждава първо да синхронизираш работата си с последното състояние на отдалеченото хранилище."
            ]
          }
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "Достатъчно теория — нека видим това в действие."
            ],
            "afterMarkdowns": [
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "Как се решава тази ситуация? Лесно — просто трябва да базираш работата си върху най-новата версия на отдалечения бранч.",
              "",
              "Има няколко начина да направиш това, но най-директният е чрез rebase. Нека видим как изглежда."
            ]
          }
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "Ако направим rebase преди да push-нем..."
            ],
            "afterMarkdowns": [
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "Има ли и други начини да обновиш работата си, когато отдалеченото хранилище се е променило? Разбира се! Нека видим същото, но този път с `merge`.",
              "",
              "Макар че `git merge` не премества комитите ти (а просто създава merge комит), това е начин да кажеш на Git, че си включил всички промени от отдалечения бранч.",
              "",
              "Това работи, защото отдалеченият бранч вече е *предшественик* на твоя — което означава, че комитите ти отразяват всички комити от отдалечения бранч.",
              "",
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "Супер! А има ли начин да направя всичко това без да пиша толкова много команди?",
              "",
              "Разбира се — вече знаеш, че `git pull` е съкратен вариант за fetch + merge. По същия начин `git pull --rebase` е съкратен вариант за fetch + rebase!",
              "",
              "Нека видим тези съкратени команди в действие."
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "Този работен процес — fetch, rebase/merge и push — е изключително често срещан.",
              "",
              "В следващите уроци ще разгледаме по-сложни варианти, но засега нека пробваш това сам.",
              "",
              "За да решиш нивото, направи следното:",
              "",
              "* Клонирай хранилището",
              "* Симулирай екипна работа (1 комит)",
              "* Направи собствен комит (1 комит)",
              "* Публикувай работата си чрез *rebase*"
            ]
          }
        }
      ]
    ...
    "uk": {
      "childViews": [
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "Уявіть, що Ви склонували репозиторій у понеділок і почали працювати над якоюсь можливістю. У п’ятницю можливість готова і Ви хочете повернути її назад (в апстрім) -- але що це? Ваші колеги, грець їм, вже встигли вкомітити купу коду, що робить Вашу можливість застарілою (і не дуже доречною). Вони вже запушили ці коміти в публічний репозиторій, й тепер *Ваша* робота базується на *старій* версії продукту, що вже не актуальна.",
              "",
              "В цьому випадку команда `git push` неоднозначна. Коли Ви виконаєте `git push`, гіт повинен змінити віддалений репозиторій до того стану, на якому він знаходився в понеділок? Чи він має додати Ваш код і залишити код Ваших колег? Чи він має повністю проігнорувати Ваші зміни, оскільки вони застаріли?",
              "",
              "Через такі неоднозначності в цій ситуації (коли історія розійшлася), git не дозволить Вам запушити Ваші зміни. Він фактично змушує Вас інтегрувати останні зміни з віддаленого репозиторію перед тим як Ви зможете завантажити на нього свої напрацювання."
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Є кілька шляхів як цього досягнути, але найпростіший -- це перемістити Вашу роботу 'вперед' за допомогою rebase. Спробуймо і погляньмо як це виглядає."
            ]
          }
        },
        {
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Хоча `git merge` і не переміщує Вашу роботу (а просто створює натомість коміт злиття чи merge commit), це -- ще один спосіб сказати git, що Ви інтегрували останній стан віддаленого репозиторію в свої зміни. Це працює тому, що тепер віддалена гілка є *предком* Вашої гілки, а отже Ваші останні коміти інтегрують в собі всі коміти з віддаленої гілки.",
              "",
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Звісно -- Ви ж знаєте, що `git pull` це просто коротша форма для git fetch а потім git merge. Натомість, `git pull --rebase` це коротка форма для git fetch а потім git rebase!",
              "",
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              ...
              "* Зробіть симуляцію командної роботи (1 коміт)",
              "* Зробіть власний коміт (1 коміт)",
