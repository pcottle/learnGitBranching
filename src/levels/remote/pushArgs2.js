exports.level = {
  ...
  "hint": {
    ...
    "uk": "Пам'ятайте, Ви завжди можете визнати поразку і підглянути рішення командою \"show solution\" :P",
      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "З попереднього уроку нам відомо, що коли ми вказуємо `main` як аргумент place для git push, ми задаємо і гілку, *з якої* брати нові коміти, і гілку *до якої* їх буде перенесено.",
              "",
              "Тут Ви можете задуматись, а чи можуть гілки, звідки беремо, і куди переносимо, бути різними? Що, коли потрібно коміти з локальної гілки `foo` перенести у віддалену гілку `bar`?",
              "",
        ...
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "Пам'ятайте, `source` -- це будь-яка назва місця, зрозуміла гіту:"
            ],
            "afterMarkdowns": [
        ...
        },
        {
          ...
          "options": {
            "beforeMarkdowns": [
              "А що, коли вказаного місця призначення не існує? Нема проблем! Просто вкажіть назву гілки і гіт створить її на віддаленому сервері."
            ],
            "afterMarkdowns": [
              "Спритно, еге-ж? :D"
            ],
        ...
        },
        {
          ...
          "options": {
            "markdowns": [
              "На цьому рівні спробуйте досягти стану репозиторію, показаного у візуалізації і пам'ятайте про формат запису з двокрапкою:",
              "",
              "`<source>:<destination>`"
            ]
          }
