exports.level = {
  ...
  "hint": {
    ...
    "uk": "Пам'ятайте, Ви в будь-який момент можете використовувати команди undo або reset",
      ...
      "childViews": [
        {
          ...
          "options": {
            "markdowns": [
              ...
              "",
              "Тепер, коли Ви вже впевнено володієте засобами `pull` та `push`, час перевірити ці знання в новому процесі.",
              "",
              ...
              "",
              "* інтеграцію гілки з можливістю в `main`, і",
